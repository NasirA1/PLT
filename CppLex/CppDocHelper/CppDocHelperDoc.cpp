...
void CCppDocHelperDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CCppDocHelperDoc::InitializeSearchContent()
{
...
void CCppDocHelperDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
