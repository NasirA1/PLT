...
BEGIN_MESSAGE_MAP(CCppDocContentView, CScintillaView)
	...
	//ON_COMMAND(ID_OPTIONS_DELETEMARKER, &CCppDocContentView::OnOptionsDeletemarker)
	//ON_COMMAND(ID_OPTIONS_FIND_NEXTMARKER, &CCppDocContentView::OnOptionsFindNextmarker)
	//ON_COMMAND(ID_OPTIONS_FIND_PREVMARKER, &CCppDocContentView::OnOptionsFindPrevmarker)
	//ON_COMMAND(ID_OPTIONS_FOLD_MARGIN, &CCppDocContentView::OnOptionsFoldMargin)
	//ON_COMMAND(ID_OPTIONS_SELECTION_MARGIN, &CCppDocContentView::OnOptionsSelectionMargin)
	//ON_COMMAND(ID_OPTIONS_VIEW_LINENUMBERS, &CCppDocContentView::OnOptionsViewLinenumbers)
	//ON_UPDATE_COMMAND_UI(ID_INDICATOR_LINE, &CCppDocContentView::OnUpdateLine)
	//ON_UPDATE_COMMAND_UI(ID_INDICATOR_STYLE, &CCppDocContentView::OnUpdateStyle)
	//ON_UPDATE_COMMAND_UI(ID_INDICATOR_FOLD, &CCppDocContentView::OnUpdateFold)
	//ON_UPDATE_COMMAND_UI(ID_OPTIONS_DELETEMARKER, &CCppDocContentView::OnUpdateOptionsDeletemarker)
	//ON_UPDATE_COMMAND_UI(ID_OPTIONS_SELECTION_MARGIN, &CCppDocContentView::OnUpdateOptionsSelectionMargin)
	//ON_UPDATE_COMMAND_UI(ID_OPTIONS_VIEW_LINENUMBERS, &CCppDocContentView::OnUpdateOptionsViewLinenumbers)
...
void CCppDocContentView::OnDraw(CDC* /*pDC*/)
{
	CCppDocHelperDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
